shmn core version 2.3.0 is now available from:

  <https://github.com/shmn-project/shmn/releases>
...
Please report bugs using the issue tracker at github:
  ...
  <https://github.com/shmn-project/shmn/issues>

Compatibility
==============

shmn core is extensively tested on multiple operating systems using
...
shmn core should also work on most other Unix-like systems but is not
...
[
  {
    ...
    winner: {
        address: addr,    (string) shmn MN Address,
...
shmn core now enables bloom filters by default to support SPV clients like mobile wallets. This feature can be disabled by using the `-peerbloomfilters` option on startup.
...
- #195 `aee05fe` [ZMQ] ZMQ integration for shmn (Mrs-X)
...
### Tests and QA
- #191 `3a778c3` [Tests] Fix the unit test suite for use with shmn (Fuzzbawls)
...
As well as everyone that helped translating on [Transifex](https://www.transifex.com/projects/p/shmn-project-translations/).
