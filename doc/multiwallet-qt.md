...
In order to support loading of multiple wallets in shmn-qt, a few changes in the UI architecture will be needed.
...
Only requiring some minor changes is shmn.cpp.
...
Changes to shmn.cpp
----------------------
shmn.cpp is the entry point into shmn-qt, and as such, will require some minor modifications to provide hooks for
