...
static const CRPCCommand vRPCCommands[] =
    {
        ...
        /* shmn features */
        {"shmn", "masternode", &masternode, true, true, false},
        {"shmn", "masternodelist", &masternodelist, true, true, false},
        {"shmn", "mnbudget", &mnbudget, true, true, false},
        {"shmn", "mnbudgetvoteraw", &mnbudgetvoteraw, true, true, false},
        {"shmn", "mnfinalbudget", &mnfinalbudget, true, true, false},
        {"shmn", "mnsync", &mnsync, true, true, false},
        {"shmn", "spork", &spork, true, true, false},
#ifdef ENABLE_WALLET
        {"shmn", "obfuscation", &obfuscation, false, false, true}, /* not threadSafe because of SendMoney */
...
void StartRPCThreads()
{
    ...
    if (((mapArgs["-rpcpassword"] == "") ||
        ...
        uiInterface.ThreadSafeMessageBox(strprintf(
                                             _("To use shmnd, or the -server option to shmn-qt, you must set an rpcpassword in the configuration file:\n"
                                               "%s\n"
...
{
    return "> shmn-cli " + methodname + " " + args + "\n";
}
...
std::string HelpExampleRpc(string methodname, string args)
{
    return "> curl --user myusername --data-binary '{\"jsonrpc\": \"1.0\", \"id\":\"curltest\", "
           "\"method\": \"" +
           methodname + "\", \"params\": [" + args + "] }' -H 'content-type: text/plain;' http://127.0.0.1:50006/\n";
}
