...
static bool AppInitRawTx(int argc, char* argv[])
{
    ...
    if (argc < 2 || mapArgs.count("-?") || mapArgs.count("-help")) {
        ...
        std::string strUsage = _("shmn core shmn-tx utility version") + " " + FormatFullVersion() + "\n\n" +
                               _("Usage:") + "\n" +
                               "  shmn-tx [options] <hex-tx> [commands]  " + _("Update hex-encoded shmn transaction") + "\n" +
                               "  shmn-tx [options] -create [commands]   " + _("Create hex-encoded shmn transaction") + "\n" +
                               "\n";
...
static int CommandLineRawTx(int argc, char* argv[])
{
    ...
    try {
        ...
        if (!fCreateBlank) {
            ...
            // param: hex-encoded shmn transaction
