                                                                            ...
                                                                            spinnerFrame(0)
{
    ...
    QString windowTitle = tr("shmn core") + " - ";
#ifdef ENABLE_WALLET
...
void BitcoinGUI::createActions(const NetworkStyle* networkStyle)
{
    ...
    sendCoinsAction->setStatusTip(tr("Send coins to a shmn address"));
    ...
    receiveCoinsAction->setStatusTip(tr("Request payments (generates QR codes and shmn: URIs)"));
    ...
    aboutAction = new QAction(networkStyle->getAppIcon(), tr("&About shmn core"), this);
    aboutAction->setStatusTip(tr("Show information about shmn core"));
    ...
    optionsAction->setStatusTip(tr("Modify configuration options for shmn"));
    ...
    signMessageAction->setStatusTip(tr("Sign messages with your shmn addresses to prove you own them"));
    verifyMessageAction = new QAction(QIcon(":/icons/transaction_0"), tr("&Verify message..."), this);
    verifyMessageAction->setStatusTip(tr("Verify messages to ensure they were signed with specified shmn addresses"));
    ...
    openAction->setStatusTip(tr("Open a shmn: URI or payment request"));
    openBlockExplorerAction = new QAction(QIcon(":/icons/explorer"), tr("&Blockchain explorer"), this);
    openBlockExplorerAction->setStatusTip(tr("Block explorer window"));

    showHelpMessageAction = new QAction(QApplication::style()->standardIcon(QStyle::SP_MessageBoxInformation), tr("&Command-line options"), this);
    showHelpMessageAction->setMenuRole(QAction::NoRole);
    showHelpMessageAction->setStatusTip(tr("Show the shmn core help message to get a list with possible shmn command-line options"));
...
void BitcoinGUI::createTrayIcon(const NetworkStyle* networkStyle)
{
    ...
    QString toolTip = tr("shmn core client") + " " + networkStyle->getTitleAddText();
...
void BitcoinGUI::setNumConnections(int count)
{
    ...
    labelConnectionsIcon->setToolTip(tr("%n active connection(s) to shmn network", "", count));
}
...
{
    QString strTitle = tr("shmn core"); // default title
