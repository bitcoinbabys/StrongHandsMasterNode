Contributing to shmn core
============================

The shmn core project operates an open contributor model where anyone is
...
The following applies to code changes to the shmn core project, and is not to be
confused with overall shmn Network Protocol consensus changes.

Whether a pull request is merged into shmn core rests with the project merge
...
Patches that change shmn consensus rules are considerably more involved than
...
Where a patch set proposes to change the shmn consensus, it must have been
...
The project leader is the release manager for each shmn core release.
