...
RESOURCES += src/qt/shmn.qrc src/qt/shmn_locale.qrc

TRANSLATIONS += src/qt/locale/shmn_bg.ts \
                src/qt/locale/shmn_de.ts \
                src/qt/locale/shmn_en.ts \
                src/qt/locale/shmn_es.ts \
                src/qt/locale/shmn_fi.ts \
                src/qt/locale/shmn_fr.ts \
                src/qt/locale/shmn_it.ts \
                src/qt/locale/shmn_ja.ts \
                src/qt/locale/shmn_pl.ts \
                src/qt/locale/shmn_pt.ts \
                src/qt/locale/shmn_ru.ts \
                src/qt/locale/shmn_sk.ts \
                src/qt/locale/shmn_sv.ts \
                src/qt/locale/shmn_vi.ts \
                src/qt/locale/shmn_zh_CN.ts \
                src/qt/locale/shmn_zh_TW.ts
